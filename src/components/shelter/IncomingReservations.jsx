import { Accessibility, Clock3, Users } from 'lucide-react'

function IncomingReservations({ reservations }) {
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 text-sm text-slate-600">
              ...
              <span>
                ...
                {reservation.elderly} elderly
              </span>
            </div>

            {reservation.mobilityAssistance && (
